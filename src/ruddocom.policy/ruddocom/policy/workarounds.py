...
try:
    ...
    LOGGER.warn("Alias registered for missing: PloneLanguageTool.LanguageTool.LanguageTool")
...
try:
    ...
    class IArchetypesTranslatable(Interface):
        ...
        pass
    alias_module('archetypes.multilingual.interfaces.IArchetypesTranslatable', IArchetypesTranslatable)
    LOGGER.warn("Alias registered for missing: archetypes.multilingual.interfaces.IArchetypesTranslatable")
...
try:
    ...
    class IMultiLanguagePolicies(Interface):
        '''interface used for alias'''
        pass
    alias_module('plone.app.multilingual.browser.controlpanel.IMultiLanguagePolicies', IArchetypesTranslatable)
    LOGGER.warn("Alias registered for missing: plone.app.multilingual.browser.controlpanel.IMultiLanguagePolicies")
